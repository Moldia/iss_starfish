...
FILENAME = ["HCA_07_cycle1_b(2)_stitched",
            "HCA_07_cycle2_b(2)_stitched",
            "HCA_07_cycle3(2)_stitched",
            "190112_HCA_07_cyc4(2)_stitched"]

# codebook in csv (column 1: code, column2-x: color code in each round)
# AVOID comma in gene names (column 1)
codebook_csv = r"E:\HCA_07_mouse_32genes\mouse_starfish_codebook.csv"
...
pixelscale = 0.1625
tilepos_xy_csv = r"E:\HCA_07_mouse_32genes\Preprocessing\ReslicedTiles\tilepos.csv"
...
# file location
input_dir = r"E:\HCA_07_mouse_32genes\Preprocessing\ReslicedTiles"
output_dir = r"E:\HCA_07_mouse_32genes\upload_starfish_190409\ISS_mouse_HCA_07_32genes"
...
write_experiment_json(
    path=output_dir, fov_count=168, tile_format=ImageFormat.TIFF,
