...
# imaging
channels = ["DAPI", "AF750", "AF488", "Cy3", "TexasRed", "Cy5"]

# codebook in csv (column 1: code, column2-x: color code in each round)
# AVOID comma in gene names (column 1)
codebook_csv = r"D:\HDCA_heart_w6.5\code_heart_starfish.csv"
DO_decorators = ["Cy5", "TexasRed", "Cy3", "AF488"]
CHORDER = [channels.index(i) for i in DO_decorators]

# tile position and metadata
# TODO: read metadata using bio-format
pixelscale = 0.325
tilepos_xy_csv = r"D:\HDCA_heart_w6.5\Preprocessing\ReslicedTiles\tilepos.csv"
...
# file location
input_dir = r"D:\HDCA_heart_w6.5\Preprocessing\ReslicedTiles"
output_dir = r"D:\HDCA_heart_w6.5\upload_starfish_190403"
...
class ISS2DPrimaryTileFetcher(TileFetcher):
    ...
    def get_tile(self, fov: int, r: int, ch: int, z: int) -> FetchedTile:
        return ISSTile2D(os.path.join(self.path, "base{}(1)_stitched-{}/tile{}.tif".format(r+1, CHORDER[ch]+1, fov+1)), fov)
...
write_experiment_json(
    ...
    aux_tile_fetcher={
        'nuclei': ISS2DAuxTileFetcher(input_dir, "base1(1)_stitched-1/tile"),
        'dots': ISS2DAuxTileFetcher(input_dir, "base1(1)_stitched-2/tile"),
    },
